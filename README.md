...
* Requirements: `['numpy>=1.24.4; python_version=="3.9"']`,
* Uses the default path of CUDA & CUDNN `C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.8`. 
* The supported hardware for **Python 3.9** + **CUDA 11.8**:
  ```
...
* Terminal `cmd` -> Config `nonfree` modules (Optional)
  ...
  ```
* Terminal `cmd` -> Config python (3.9)
  ```
  -DPYTHON3_LIMITED_API=ON ^
  -DPYTHON3_EXECUTABLE="C:/dev/exc/python/p39/python.exe" ^
  -DPYTHON3_INCLUDE_DIR="C:/dev/exc/python/p39/include" ^
  -DPYTHON3_LIBRARY="C:/dev/exc/python/p39/libs/python39.lib" ^
  -DPYTHON3_NUMPY_INCLUDE_DIRS="C:/dev/exc/python/p39/lib/site-packages/numpy/core/include" ^
  -DPYTHON3_PACKAGES_PATH="C:/dev/exc/python/p39/Lib/site-packages" ^
